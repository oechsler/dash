...
type DashboardTitleApplicationsInput struct {
	EditMode bool
	IsAdmin  bool
}

func DashboardTitleApplications(input DashboardTitleApplicationsInput) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if !input.EditMode || input.IsAdmin {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div id=\"apps-title\" class=\"flex flex-wrap items-center justify-between gap-4 mb-4\"><div class=\"min-w-0\"><h2 class=\"text-xl uppercase font-semibold text-secondary break-all\">")
			if templ_7745c5c3_Err != nil {
